...
class HirerRequestCard extends StatelessWidget {
  ...
  const HirerRequestCard({Key? key, required this.requestWorker, required this.isdark})
      : super(key: key);
  @override
...
class WorkerRequestCard extends StatelessWidget {
  ...
  const WorkerRequestCard({Key? key, required this.hirerRequest, required this.isdark})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
